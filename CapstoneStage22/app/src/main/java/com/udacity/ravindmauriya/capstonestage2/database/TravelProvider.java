...
import static com.udacity.ravindmauriya.capstonestage2.database.DatabaseSave.TABLE_PLACES;

/**
 * A Content Provider for WatchThemAll show data
 */
public class TravelProvider extends ContentProvider {
    static final String PROVIDER_NAME = "com.udacity.ravindmauriya.capstonestage2.provider";
