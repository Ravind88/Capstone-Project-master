...
import com.udacity.ravindmauriya.capstonestage2.ui.reviews.ReviewActivity;
...
public class PlaceDetailActivity extends BaseActivity implements OnMapReadyCallback, PlaceDetailView {
    ...
    protected void initUi() {
        ...
        final String place_id = getIntent().getStringExtra(Constants.PLACE_ID);
        choice = getIntent().getIntExtra(Constants.CHOICE, 0);
        url = "https://maps.googleapis.com/maps/api/place/details/json?placeid=" + place_id + "&key=" + getString(R.string.api_key);
