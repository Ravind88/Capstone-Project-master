...
import com.udacity.ravindmauriya.capstonestage2.ui.register.RegisterActivity;
...
public class LoginActivity extends BaseActivity implements LoginView, FbCallback {
    ...
    protected void initUi() {
        ...
        findViewById(R.id.register_in_txtvw).setOnClickListener(this);
    ...
    @Override
    public void navigateFromFbHome(FBBean bean) {
        Utility.putBooleanValueInSharedPreference(getActivity(), Constants.PREFS_LOGGED_IN, true);
        Utility.putStringValueInSharedPreference(getActivity(), Constants.PREFS_USER_NAME, bean.getFirstName());
    ...
    public void onLoginSuccess(FBBean beanObject) {
        Log.e("data", beanObject.toString());
        mPresenter.attemptFbLogin(beanObject);
